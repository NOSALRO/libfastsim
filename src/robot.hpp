...
namespace fastsim {
    ...
    public:
        ...
        Robot(float radius) : _radius(radius),
                              _pos(0, 0, 0),
                              _left_bumper(false),
                              _right_bumper(false),
                              _use_camera(false),
        ...
        Robot(float radius, const Posture& pos) : _radius(radius), _pos(pos), _left_bumper(false), _right_bumper(false), _use_camera(false), _collision(false), _vx(0), _vy(0), _va(0)
        {
            _bb.w = _radius * 2 + 8;
            _bb.h = _radius * 2 + 8;
        ...
        Posture line_collision(const std::vector<std::vector<float>>& points, const std::shared_ptr<Map>& m);
