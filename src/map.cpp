...
namespace fastsim {
    ...
    bool Map::_check_inter_ray_circle(float x1, float y1, float x2, float y2, float xr, float yr, float radius) const
    {
    ...
    int Map::check_inter_is(float x1, float y1, float x2, float y2) const
    {
    ...
    bool Map ::check_inter_pixel(int y1, int x1, int y2, int x2, int& y_res, int& x_res) const
    {
        int i; // loop counter
