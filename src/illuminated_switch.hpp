...
namespace fastsim {
    ...
    public:
        ...
        IlluminatedSwitch(int color, float radius, float x, float y, bool on) : _color(color),
                                                                                _radius(radius),
                                                                                _x(x),
                                                                                _y(y),
                                                                                _on(on),
    ...
    struct ClosestSwitch_f {
        ...
        bool operator()(const std::shared_ptr<IlluminatedSwitch> i1, const std::shared_ptr<IlluminatedSwitch> i2)
        {
